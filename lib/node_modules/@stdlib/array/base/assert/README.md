...
```javascript
const ns = require( '@stdlib/array/base/assert' );
```
...
const arr4 = new Complex128Array( [ 1.0, 1.0, 2.0, 2.0 ] ); // two complex numbers: 1+1i, 2+2i

// Get data types:
const dt1 = dtype( arr1 );
const dt2 = dtype( arr2 );
const dt3 = dtype( arr3 );
const dt4 = dtype( arr4 );
