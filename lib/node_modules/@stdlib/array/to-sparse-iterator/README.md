...
```javascript
const sparsearray2iterator = require( '@stdlib/array/to-sparse-iterator' );
```
...
```javascript
const it = sparsearray2iterator( [ 1, , , 4 ] );
// returns <Object>
...
const it = sparsearray2iterator( [ 1, , 3, 4 ], fcn );
// returns <Object>
...
const it = sparsearray2iterator( [ 1, 2, , 4 ], fcn );
// returns <Object>
...
const it = sparsearray2iterator( [ 1, , 3, 4 ], fcn, ctx );
// returns <Object>
...
const it = sparsearray2iterator( arr, scale );
