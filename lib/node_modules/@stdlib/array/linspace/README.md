...
```javascript
const arr = linspace( 0.0, 100.0, 6 );
...
```javascript
const arr = linspace( 0.0, 100.0, 0 );
...
const arr = linspace( 0, 100, 6, opts );
...
const stop = new Complex128( 100.0, 10.0 );

const arr = linspace( start, stop, 6, opts );
...
const arr = linspace.assign( 0.0, 100.0, out );
// returns <Float64Array>[ 0.0, 20.0, 40.0, 60.0, 80.0, 100.0 ]
...
```javascript
const arr = linspace.assign( 0.0, 100.0, [] );
// returns []
```
...
```javascript
let arr = linspace.assign( 0.0, 100.0, [ -10.0 ] );
// returns [ 100.0 ]
...
const arr = linspace.assign( 0.0, 100.0, out, opts );
// returns <Float64Array>[ 0.0, 20.0, 40.0, 60.0, 80.0 ]
```
