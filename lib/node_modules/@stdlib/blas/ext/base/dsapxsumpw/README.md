...
```javascript
const dsapxsumpw = require( '@stdlib/blas/ext/base/dsapxsumpw' );
```
...
const v = dsapxsumpw.ndarray( N, 5.0, x, 1, 0 );
// returns 16.0
```
...
const v = dsapxsumpw.ndarray( 4, 5.0, x, 2, 1 );
// returns 25.0
```
...
const v = dsapxsumpw( x.length, 5.0, x, 1 );
console.log( v );
```
