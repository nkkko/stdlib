...
const v = dnannsum( x.length, x, 1, out, 1 );
...
const v = dnannsum( 4, x1, 2, out1, 1 );
...
const v = dnannsum.ndarray( x.length, x, 1, 0, out, 1, 0 );
// returns <Float64Array>[ 1.0, 3 ]
```
...
const v = dnannsum.ndarray( 4, x, 2, 1, out, 2, 1 );
