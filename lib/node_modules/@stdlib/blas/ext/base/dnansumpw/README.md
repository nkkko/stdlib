...
```javascript
const dnansumpw = require( '@stdlib/blas/ext/base/dnansumpw' );
```
...
const v = dnansumpw.ndarray( 4, x, 1, 0 );
// returns 1.0
```
...
const v = dnansumpw.ndarray( 4, x, 2, 1 );
// returns 5.0
```
...
const v = dnansumpw( x.length, x, 1 );
console.log( v );
```
