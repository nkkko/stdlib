...
```javascript
const inmapRight = require( '@stdlib/utils/inmap-right' );
```
...
const out = inmapRight( arr, scale );
// returns [ 0, 2, 6, 12 ]
...
const out = inmapRight( arr, sum, context );
// returns [ 1, 2, 3, 4 ]
