...
```javascript
const uncurryRight = require( '@stdlib/utils/uncurry-right' );
```
...
const curryRight = require( '@stdlib/utils/curry-right' );
const uncurryRight = require( '@stdlib/utils/uncurry-right' );
...
const uncurried = uncurryRight( curried );
